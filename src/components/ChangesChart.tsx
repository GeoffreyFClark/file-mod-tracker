...
const ChangesChart: React.FC = () => {
  useEffect(() => {
    // Initialize Flowbite
    initFlowbite();

    // Initialize ApexCharts
    const chart = new ApexCharts(document.querySelector("#pie-chart"), getChartOptions());
    chart.render();
  ...
  const getChartOptions = () => {
    return {
      ...
      labels: ["Deletions", "Renamings", "Content changes"],
      dataLabels: {
        enabled: true,
        style: {
      ...
      <div className="flex justify-between items-start w-full">
        <div className="flex-col items-center">
          <div className="flex items-center mb-1">
            <h5 className="text-xl font-bold leading-none text-gray-900 dark:text-white me-1">Modifications</h5>
            ...
            <div data-popover id="chart-info" role="tooltip" className="absolute z-10 invisible inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">
              <div className="p-3 space-y-2">
                ...
                <p>GatorSec collects more types of metadata which are viewable when examining specific changes.</p>
                <a href="#" className="flex items-center font-medium text-blue-600 dark:text-blue-500 dark:hover:text-blue-600 hover:text-blue-700 hover:underline">Inspect <svg className="w-2 h-2 ms-1.5 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
