...
const DetectionsChart: React.FC = () => {
  useEffect(() => {
    // Initialize Flowbite
    initFlowbite();
  ...
  return (
    <div className="w-full bg-white rounded-lg shadow dark:bg-gray-800 p-6 md:p-6">
      <div className="flex justify-between">
        <div>
          <h5 className="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">32</h5>
          <p className="text-base font-normal text-gray-500 dark:text-gray-400">Detections this week</p>
        </div>
        <div
